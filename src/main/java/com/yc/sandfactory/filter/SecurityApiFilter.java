 ...
 */
@WebFilter(filterName = "apiTokenFilter", value = {"/api/*"})
public class SecurityApiFilter implements Filter {

    private Logger logger = LoggerFactory.getLogger(this.getClass());

    private static final String URL_PREF = "api/";

    private static final String PUBLIC_PREF = "api/public";

    private static final String ANONY_PREF = "api/anony";
    ...
    public void doFilter(ServletRequest req, ServletResponse resp,
        ...
        if(!uri.startsWith(PUBLIC_PREF)) {//非公共地址
            ...
            String token = authHeader; // The part after "Bearer "
